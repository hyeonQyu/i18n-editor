import { TranslationFileEditorProps } from '../index';
import { INITIAL_TABLE_EXTEND_DIALOG_DATA } from '../defines';
import { IUseTranslationFileEditor } from '../useTranslationFileEditor';
