import TranslationDeleteConfirmDialog from '@components/NamespaceEditor/components/NamespaceEditorVirtualTable/components/NamespaceEditorRow/components/NamespaceEditorCell/components/MenuCell/components/RowMenu/components/TranslationDeleteConfirmDialog';
...
function RowMenu(props: RowMenuProps) {
  ...
  return (
    <>
      ...
      <TranslationDeleteConfirmDialog />
    </>
  );
}
