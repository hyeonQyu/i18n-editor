import { LocaleDirectoryCreationDialogBeforeProps } from '@components/localeDirectoryCreationDialog';
...
export interface IUseLocaleDirectoryCreationDialogBeforeParams extends LocaleDirectoryCreationDialogBeforeProps {}

export interface IUseLocaleDirectoryCreationBeforeDialog {
 ...
 * @param params
 */
function useLocaleDirectoryCreationDialogBefore(
  params: IUseLocaleDirectoryCreationDialogBeforeParams,
): IUseLocaleDirectoryCreationBeforeDialog {
...
export default useLocaleDirectoryCreationDialogBefore;
