...
type GeneralRefObject = MutableRefObject<HTMLElement | null | undefined>;

function useClickOutside(ref: GeneralRefObject | GeneralRefObject[], onClickOutside: (e: MouseEvent) => void) {
  useEffect(() => {
